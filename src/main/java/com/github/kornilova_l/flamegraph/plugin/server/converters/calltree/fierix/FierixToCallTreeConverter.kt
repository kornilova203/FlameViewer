...
import com.github.kornilova_l.flamegraph.plugin.server.converters.calltree.FileToCallTreeConverterBase
...
class FierixToCallTreeConverter(file: File) : FileToCallTreeConverterBase(file) {
