...
public class ConfigCheckboxTree extends CheckboxTree {
    ...
    public void initTree(@NotNull Collection<MethodConfigOld> methods) {
        root.removeAllChildren();
        for (MethodConfigOld methodConfig : methods) {
    ...
    @NotNull
    private ConfigCheckedTreeNode addMethodNode(MethodConfigOld methodConfig) {
    ...
    @Nullable
    public MethodConfigOld getSelectedConfig() {
        ...
        if (userObject instanceof MethodConfigOld) {
            return ((MethodConfigOld) userObject);
        }
        return null;
    }

    public void addNode(MethodConfigOld methodConfig) {
