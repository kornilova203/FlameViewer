...
class FierixToCallTreeConverterFactory : ToCallTreeIdentifiedConverterFactory {
    ...
    override fun create(file: File) = FierixToCallTreeConverter(file) { LOG.warn(it) }
    ...
    companion object {
        ...
        private val LOG = Logger.getInstance(FierixToCallTreeConverterFactory::class.java)
