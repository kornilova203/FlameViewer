//package com.github.kornilova_l.flamegraph.config;
//
...
//public class MethodConfigOld implements Comparable<MethodConfigOld> {
...
//    public MethodConfigOld() {
//        methodPatternString = "";
//        classPatternString = "";
//    }
//
//    MethodConfigOld(PsiMethod psiMethod) {
//        methodPatternString = "";
//        classPatternString = "";
//        setNames(psiMethod);
//    }
//
//    MethodConfigOld(String methodConfigLine) {
//        methodPatternString = "";
//        classPatternString = "";
//        setNames(methodConfigLine);
//    }
//
//    public MethodConfigOld(@NotNull String classPatternString, @NotNull String methodPatternString, @NotNull String parametersPattern) {
...
//
//    @NotNull
//    private static LinkedList<MethodConfigOld.Parameter> getParametersList(PsiParameter[] psiParameters) {
//        LinkedList<MethodConfigOld.Parameter> parameters = new LinkedList<>();
//        for (PsiParameter psiParameter : psiParameters) {
//            if (psiParameter.getTypeElement() == null ||
//                    psiParameter.getName() == null) {
//                continue;
//            }
//            parameters.add(new MethodConfigOld.Parameter(
...
//            MethodConfigOld.Parameter parameter = parameters.get(i);
...
//
//    @Override
//    public int compareTo(@NotNull MethodConfigOld o) {
