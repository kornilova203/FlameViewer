...
public final class TreesProtos {
  ...
  public  static final class Trees extends
    ...
    public static final com.github.kornilova_l.libs.com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return TreesProtos.internal_static_com_github_kornilova_l_protos_src_Trees_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return TreesProtos.internal_static_com_github_kornilova_l_protos_src_Trees_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              TreesProtos.Trees.class, TreesProtos.Trees.Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof TreesProtos.Trees)) {
        return super.equals(obj);
      }
      TreesProtos.Trees other = (TreesProtos.Trees) obj;
    ...
    public static TreesProtos.Trees parseFrom(
    ...
    public static TreesProtos.Trees parseFrom(byte[] data)
        throws com.github.kornilova_l.libs.com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static TreesProtos.Trees parseFrom(
    ...
    public static TreesProtos.Trees parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static TreesProtos.Trees parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.github.kornilova_l.libs.com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static TreesProtos.Trees parseDelimitedFrom(
        java.io.InputStream input,
        com.github.kornilova_l.libs.com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.github.kornilova_l.libs.com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(TreesProtos.Trees prototype) {
    ...
    public static final class Builder extends
      ...
      public TreesProtos.Trees getDefaultInstanceForType() {
        return TreesProtos.Trees.getDefaultInstance();
      }

      public TreesProtos.Trees build() {
        TreesProtos.Trees result = buildPartial();
      ...
      public TreesProtos.Trees buildPartial() {
        TreesProtos.Trees result = new TreesProtos.Trees(this);
      ...
      public Builder mergeFrom(com.github.kornilova_l.libs.com.google.protobuf.Message other) {
        if (other instanceof TreesProtos.Trees) {
          return mergeFrom((TreesProtos.Trees)other);
        } else {
      ...
      public Builder mergeFrom(TreesProtos.Trees other) {
        if (other == TreesProtos.Trees.getDefaultInstance()) return this;
        if (treesBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.github.kornilova_l.libs.com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        TreesProtos.Trees parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.github.kornilova_l.libs.com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (TreesProtos.Trees) e.getUnfinishedMessage();
      ...
      public Builder addAllTrees(
          Iterable<? extends com.github.kornilova_l.protos.TreeProtos.Tree> values) {
        if (treesBuilder_ == null) {
          ensureTreesIsMutable();
    ...
    private static final TreesProtos.Trees DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new TreesProtos.Trees();
    }

    public static TreesProtos.Trees getDefaultInstance() {
