...
public abstract class ConfigItem extends ItemWrapper implements Comparable<ConfigItem>, Navigatable {
    ...
    public boolean equals(Object o) {
        ...
        com.intellij.xdebugger.impl.breakpoints.ui.BreakpointItem item = (com.intellij.xdebugger.impl.breakpoints.ui.BreakpointItem)o;

        if (getConfig() != null ? !getConfig().equals(item.getBreakpoint()) : item.getBreakpoint() != null) return false;
    ...
    @Override
    public int hashCode() {
        return getConfig() != null ? getConfig().hashCode() : 0;
    }
}