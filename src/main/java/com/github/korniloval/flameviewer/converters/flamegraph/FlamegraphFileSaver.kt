...
import com.github.korniloval.flameviewer.converters.calltraces.flamegraph.FlamegraphToCallTracesConverterFactory
...
class FlamegraphFileSaver : FileToFileConverterFileSaver() {
    override val extension = FlamegraphToCallTracesConverterFactory.EXTENSION
